                                ...
                                >
                                  ...
                                  <template v-else>
                                    <div class="card-media-files-editor-media-files">
                                      ...
                                      <div v-if="previewFiles.length" role="button" class="sortable-item">
                                        <div class="media-render-photo" @mouseover="isHovered = true" @mouseleave="isHovered = false">
                                          <div class="media-render-photo-labels">
                                          ...
                                          <div class="media-render-photo-dropdown" :style="{ opacity: isHovered ? 1 : 0 }">
                                          ...
                                          <img v-if="previewFiles[0].type.startsWith('image/')"
